# This code is for checking whether the results obtained about the LTWAI and GDP relationship robust 
# With removal of Covid period
...
df_q_2 <- df_monthly %>%
  ...
  filter(!is.na(Pct_change_GDP)) %>%
  filter(!(iso_year == "2020") & !(iso_year == "2021"))
